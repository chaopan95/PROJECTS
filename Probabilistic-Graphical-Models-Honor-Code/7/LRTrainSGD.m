...
% classifier using stochastic gradient descent. It returns the optimal
% theta values. 
%
% Inputs:
...
function thetaOpt = LRTrainSGD(X, y, lambda)
    ...
    % handle gradFunc(theta, i), where gradFunc only takes two input
    % params.
    %
    % For more info, you may check out the official documentation:
    % Matlab - http://www.mathworks.com/help/techdoc/matlab_prog/
    % f4-70115.html
    ...
    thetaOpt = StochasticGradientDescent(gradFn, zeros(numFeatures, 1),...
        5000);
