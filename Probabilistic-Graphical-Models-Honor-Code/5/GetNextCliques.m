...
%   clique tree, P, and a matrix of current messages. Returns indices i
%   and j such that clique i is ready to transmit a message to clique j.
%
%   We are doing clique tree message passing, so
%   do not return (i,j) if clique i has already passed a message to
%   clique j.
%
