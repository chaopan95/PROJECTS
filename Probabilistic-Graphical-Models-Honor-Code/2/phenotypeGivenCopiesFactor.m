function phenotypeFactor = phenotypeGivenCopiesFactor(alphaList,...
...
num_phenotype = 2;
num_genotype = numAlleles;
phenotypeFactor.card = [num_phenotype, num_genotype, num_genotype];
...
for i = 1:prod(phenotypeFactor.card)
    ...
    alphaIndex = allelesToGenotypes(assignment_parent1,...
        assignment_parent2);
    alpha = alphaList(alphaIndex);
    if assignment_child == 1
