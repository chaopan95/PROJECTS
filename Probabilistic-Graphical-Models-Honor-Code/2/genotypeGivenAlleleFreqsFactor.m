function genotypeFactor = genotypeGivenAlleleFreqsFactor(alleleFreqs,...
    genotypeVar)
...
for i = 1:numAlleles
    for j = 1:numAlleles
        gene_idx = allelesToGenotypes(i, j);
        genotypeFactor.val(gene_idx) = genotypeFactor.val(gene_idx) +...
