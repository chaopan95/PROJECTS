function factorList = constructGeneticNetwork(pedigree, alleleFreqs,...
    alphaList)
...
for i = 1:numPeople
    ...
    if pedigree.parents(i, 1) == 0
        factorList(i) = genotypeGivenAlleleFreqsFactor(alleleFreqs,...
            genotypeVar);
    else
        genotypeVarChild = i;
        ...
        factorList(i) = genotypeGivenParentsGenotypesFactor(...
            numAlleles, genotypeVarChild, genotypeVarParentOne,...
            genotypeVarParentTwo);
    end;
    phenotypeVar = i + numPeople;
    factorList(phenotypeVar) = ...
    phenotypeGivenGenotypeFactor(alphaList, genotypeVar, phenotypeVar);
end;
