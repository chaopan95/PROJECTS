...
for i=1:P.cliqueList(1).card(1)
    backInds(((i-1)*P.cliqueList(1).card(1)+1):...
        (i*P.cliqueList(1).card(1)))=i;
end
...
while (1), 
    ...
    % messages. Use GetNextCliques to find cliques to pass messages
    % between.
...
for i = 2:N-1
    P.cliqueList(i).val = P.cliqueList(i).val+...
        MESSAGES(i+1,i).val(backInds);
    P.cliqueList(i).val = P.cliqueList(i).val+...
        MESSAGES(i-1,i).val(forwardInds);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
