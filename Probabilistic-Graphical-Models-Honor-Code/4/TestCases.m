...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Test case 1 - a very simple influence diagram in which X1 is a random
% variable and D is a decision.  The utility U is a function of X1 and D.  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% variable X1.  D acts on X3 instead of X1 now, but still contributes
...
% 1	2	1.000000
% 2	2	1.000000
A = struct('var', [1,3], 'card', [2, 2], 'val', [1, 2, 3, 4]);
B = struct('var', [2], 'card', [2], 'val', [10, 20]);
