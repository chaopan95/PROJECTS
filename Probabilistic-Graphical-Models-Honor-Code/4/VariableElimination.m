% VariableElimination takes in a list of factors F and a list of variables
% to eliminate and returns the resulting factor after running sum-product
% to eliminate the given variables.
%
